...
//$url = 'http://api.geonames.org/findNearByWeatherJSON?formatted=true&lat=42&lng=-2&username=flightltd&style=full';

$url = 'http://api.geonames.org/findNearByWeatherJSON?formatted=true&lat='.$_REQUEST['lat'].'&lng='.$_REQUEST['lng'].'&username=flightltd&style=full';
